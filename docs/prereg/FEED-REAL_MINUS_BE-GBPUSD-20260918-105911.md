# REAL_MINUS_BE.change5.GBPUSD.h10 — feed screen
...
Real yield minus breakeven. Both legs point the same way for gold: higher real yield and lower expected inflation are each bearish.
