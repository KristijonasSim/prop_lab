# T10YIE.change5.XAUUSD.h20 — feed screen
...
10-year inflation breakeven. Gold is held as an inflation hedge, so rising expected inflation should predict gold UP.
