# DTWEXBGS.change5.BTCUSDT.h1 — feed screen
...
Broad trade-weighted dollar index — Preferred over building DXY from the FX cache: this is the series the literature uses.
...
422 independent, from `core.screen.independent_events`.
