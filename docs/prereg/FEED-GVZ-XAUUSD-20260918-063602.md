# GVZ.change5.XAUUSD.h1 — feed screen
...
CBOE gold volatility index — H-045: the best filter result this project has produced - the only one that raised profit factor AND R per day together, against 24 of 25 entry filters that raised PF while lowering R/day.
