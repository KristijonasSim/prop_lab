# VIX_TERM.change5.XAUUSD.h10 — feed screen
...
VIX3M minus VIX (term structure slope). The curve is normally upward-sloping; it INVERTS under stress. So a high slope means calm, and calm predicts the safe haven DOWN.
