# GVZ.change250.XAUUSD.h20 — feed screen
...
CBOE gold volatility index. Elevated gold vol is priced fear, and the marginal buyer in a fear episode is a hedger. High GVZ predicts gold UP. Weakest prior in the registry - vol also mean-reverts.

Source: CBOE. CBOE gold volatility index.
...
39 independent, from `core.screen.independent_events`.
