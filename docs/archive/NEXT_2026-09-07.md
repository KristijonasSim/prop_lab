...
Read `docs/archive/SESSION_2026-09-07.md` first for why. This file is only the plan.
...
Full detail in `docs/archive/STEPS_1_2_4.md`. What changed:
...
order is in `docs/archive/STEPS_1_2_4.md`. Item 3 is not skipped — item 2 needs four of its
...
**Four project-level levers are written up in `docs/IDEAS.md`** — measuring the six
